...
CREATE TABLE IF NOT EXISTS `lowcost_schema`.`transactions` (
  ...
  PRIMARY KEY (`from_id`, `date`, `ticket_number`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `lowcost_schema`.`airport_balance`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `lowcost_schema`.`airport_balance` ;

CREATE TABLE IF NOT EXISTS `lowcost_schema`.`airport_balance` (
