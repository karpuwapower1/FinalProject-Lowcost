...
public enum MessageType {
	...
	PASSWORDS_NOT_MATCH("message.error.initialization.diffrent_password"), USER_IS_NULL("message.error.null_user"),
	INTERNAL_ERROR("message.error.internal"), ADMIN_DELETING("message.error.admin_deleting"),
	...
	INVALID_CITY("message.error.invalid_city"), INVALID_DATE("message.error.invalid_date"),
	INVALID_PRICE("message.error.invalid_price"), INVALID_PASSEGER_QUANTITY("message.error.invalid_passenger_quantity"),
	...
	INVALID_CITY_NAME("message.error.invalid_city_name"), INVALID_COUNTRY_NAME("message.error.invalid_contry_name"),
	CITY_ALREADY_PRESENTS("message.error.city_already_presents"),
	CITY_CAN_NOT_BE_DELETED("message.error.city_can_not_be_deleted"), NO_SUCH_CITY("message.error.no_such_city"),
	...
	NULL_FLIGHT("message.error.null_flight"), NO_SUCH_FLIGHT("message.error.no_such_flight"),
	...
	TICKET_CAN_NOT_BE_RETURNED("message.error.ticket_can_not_be_returned"),

	INVALID_COEFFICIENT("message.error.invalid_coefficient"), INVALID_DATES("message.error.date_not_legal"),

	INSUFFICIENT_FUNDS("message.error.insufficient_funds"), INVALID_AMOUNT("message.error.invalid_amount");
