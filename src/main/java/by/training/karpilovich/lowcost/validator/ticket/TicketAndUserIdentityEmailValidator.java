...
public class TicketAndUserIdentityValidator extends Validator {
	
	private User user;
	private Ticket ticket;
	
	public TicketAndUserIdentityValidator(User user, Ticket ticket) {
		this.user = user;
		this.ticket = ticket;
	}
	@Override
	public void validate() throws ValidatorException {
		if (user == null || ticket == null || !user.getEmail().equals(ticket.getEmail())) {
