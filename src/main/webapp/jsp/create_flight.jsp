...
<header>
	<c:set var="page" value="CREATE_FLIGHT" scope="request" />
	...
	<fmt:bundle basename="pagecontent" prefix="create_flight.">
		...
		<input type="hidden" name="from_page" value="${page}" /> 
			<input type="text" class="form-control col-md-4 offset-md-4"
				...
				name="price" value="" placeholder="<fmt:message key="price"/>"
				required pattern="([0-9]{1,}(.[0-9]{0,2}){0,1}" /> <input
				type="text"
				class="form-control form-control-lg col-md-4 offset-md-4"
				name="primary_boarding_price" value=""
				placeholder="<fmt:message key="primary_boarding_price"/>" required
				pattern="([0-9]{1,}(.|,[0-9]{0,2}){0,1}" /> <input type="text"
				class="form-control form-control-lg col-md-4 offset-md-4"
				name="luggage" value="" placeholder="<fmt:message key="luggage"/>"
				required /> <input type="text"
				class="form-control form-control-lg col-md-4 offset-md-4"
				name="overweight_price" value=""
				placeholder="<fmt:message key="overweight_luggage_price"/>" required
				pattern="([0-9]{1,}(.[0-9]{0,2}){0,1}" />
			<button type="submit" class="btn btn-light col-md-4 offset-md-4"
				name="command" value="CREATE_FLIGHT">
